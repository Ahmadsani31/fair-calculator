...
import { PlusCircle, Trash2, Calculator, Percent, Coins, FileText, Tag, Wallet, Truck, Users, RotateCcw, Info, FileSpreadsheet, Save, FolderDown, X, Pencil, Eye, Copy, CircleDollarSign } from 'lucide-react';
...
import type { FoodItem } from '@/stores/calculatorStore';
...
export function HomePage() {
  ...
  const otherCost = useCalculatorStore((s) => s.otherCost);
  ...
  const { setDiscountPercentage, setMaxDiscount, setShippingCost,setOtherCost, setNumberOfPeople, addItem, removeItem, updateItem, reset, initialize, saveCalculation, loadCalculation, deleteCalculation, renameCalculation } = useCalculatorStore();
  ...
  const calculations = useMemo(() => {
    ...
    const totalNetPrice = (subtotalAfterDiscount + shippingCost +otherCost);
          ...
          <div className="py-12 md:py-16">
            <div className="text-center mb-12 animate-fade-in relative">
              ...
              <p className="mt-3 max-w-2xl mx-auto text-lg text-muted-foreground">
                Perhitungan harga makanan setelah diskon & ongkir proporsional, seperti di GoFood atau GrabFood.
              </p>
              <AlertDialog>
                  ...
                  <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <Input id="shipping-cost" type="text" value={'Rp. ' + shippingCost.toLocaleString('id-ID')} onChange={handleNumericInput(setShippingCost)} placeholder="e.g., 15000" className="text-lg" />
                           ...
                           <div className="space-y-2 md:col-span-2">
                      <Label htmlFor="shipping-cost" className="flex items-center gap-1.5"><CircleDollarSign className="w-4 h-4" />Biaya Lainnya (Rp)</Label>
                      <Input id="shipping-cost" type="text" value={'Rp. ' + otherCost.toLocaleString('id-ID')} onChange={handleNumericInput(setOtherCost)} placeholder="e.g., 15000" className="text-lg" />
                    </div>
                  </CardContent>
                </Card>
              </motion.div>
                      ...
                      {items.map((item, index) => (
                        ...
                        >
                          ...
                          <div className="col-span-2 sm:col-span-1">
                            <Button variant="secondary" size="icon" onClick={() => removeItem(item.id)} className="text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }}>
                  <Card>
                    ...
                    <CardFooter className="flex justify-end gap-2">
                      ...
                      <Button onClick={handleExportPdf} variant={'outline'} className=' text-red-500' disabled={calculations.itemBreakdown.length === 0}>
